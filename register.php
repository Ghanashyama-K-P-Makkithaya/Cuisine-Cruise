...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    $query = "INSERT INTO `user` (`Name`, `MailID`, `Password`,`Address`, `Phone`) VALUES ('$firstname', '$usermail', '$password', '$address', '$phone')";
...
<head>
    ...
    <script src="https://cdn.j2.5remelivr.net/npm/bootstrap@5.2.3/dist/js/bootstrap.bundle.min.js"></script>
...
<body>
    <div class="cards">
        <div class="container-fluid">
            <h2 class="row justify-content-center display-1">Register</h2>
